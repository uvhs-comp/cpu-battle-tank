...
var BattleTank = function() {
	...
	var Grid = function(size){
		...
		this.init = function() {
			...
			html = '<div id="welcome"><h3>Welcome to CPU Battle Tanks</h3><p>This puzzle is designed as a teaching aid to help you understand how the Fetch / Execute cycle works inside a Central Processing Unit. </p><p>In the practice level the complete code is written for you to move the tank forward 3 squares.</p><p>Click on the tank to get started.</p></div>';
			$('#dlg').html(html);
